...
:host{
  ...
  --text-field-border-color: var(--s-color-outline, ${"#70787D" /* Theme.colorOutline */});
...
:host([error=true]) .field{
  --s-color-primary: var(--s-color-error, ${"#BA1A1A" /* Theme.colorError */});
  --field-border-color: var(--s-color-error, ${"#BA1A1A" /* Theme.colorError */});
...
textarea{
  ...
  line-height: inherit;
  font-family: inherit;
  caret-color: var(--s-color-primary, ${"#006782" /* Theme.colorPrimary */});
  display: block;
...
:host([error=true]) .text{
  color: var(--s-color-error, ${"#BA1A1A" /* Theme.colorError */});
}
.text>slot[name=text]{
  display: block;
  flex-grow: 1;
