...
:host([type=success]){
  color: var(--s-color-on-success-container, ${"#002111" /* Theme.colorOnSuccessContainer */});
  background: var(--s-color-success-container, ${"#92f7bc" /* Theme.colorSuccessContainer */});
}
:host([type=warning]){
  color: var(--s-color-on-warning-container, ${"#221b00" /* Theme.colorOnWarningContainer */});
  background: var(--s-color-warning-container, ${"#ffe169" /* Theme.colorWarningContainer */});
}
:host([type=error]){
  color: var(--s-color-on-error-container, ${"#93000A" /* Theme.colorOnErrorContainer */});
  background: var(--s-color-error-container, ${"#FFDAD6" /* Theme.colorErrorContainer */});
}
svg{
  width: 24px;
  height: 24px;
