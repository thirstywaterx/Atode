...
:host{
  ...
  --search-outline-color: var(--s-color-surface-variant, ${"#DCE4E8" /* Theme.colorSurfaceVariant */});
}
.wrapper{
  display: grid;
  position: relative;
...
export class Search extends useElement({
    ...
    setup(shadowRoot) {
        ...
        const clear = shadowRoot.querySelector('.clear');
        const dropdown = shadowRoot.querySelector('[name=dropdown]');
